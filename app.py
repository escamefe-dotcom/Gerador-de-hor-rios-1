...
def obter_analise_finais_estatica() -> Tuple[pd.DataFrame, List[int], int]:
    ...
    # Mapeamento do Top 5 Finais de Minuto PELA CLASSIFICAÇÃO DESEJADA (T1 a T5)
    ...
    dados_exibicao = [
        ...
        {'Sinal': "🔥", 'Minuto Exemplo': "00", 'Final': 'T3(0)'}, # Usando 00 como exemplo para o Final 0
...
def consolidar_historico(novo_df, horario_base_dt, top_minutos_00_59_list: List[int], top_1_minuto_00_59: int):
    ...
    nos minutos completos (00-59) estáticos.
    """
