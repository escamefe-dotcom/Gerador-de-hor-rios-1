...
def obter_analise_finais_estatica() -> Tuple[pd.DataFrame, List[int], int]:
    ...
    # Criando o DataFrame para exibição (AGORA COM 🎯 NO MINUTO TOP 1)
    dados_exibicao = [
    ...
    st.dataframe(
        ...
        column_config={
            "Horário": st.column_config.TextColumn(
                ...
                # Atualizando o help para refletir a nova sinalização
                help="🎯: Minuto Top 1 | 🚀: Sinal de Alerta Top 1 | 🔥: Sinal de Alerta Top 5" 
            )
        }
    )
