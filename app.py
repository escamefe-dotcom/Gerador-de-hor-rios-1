...
def consolidar_historico(novo_df, horario_base_dt, rank_finais: Dict[int, int], top_1_minuto_00_59: int):
    ...
    for col in ['Resultado_Vela', 'Rodada_Resultante']:
    ...
    # Garante que as colunas existem no novo_df
    for col in ['Resultado_Vela', 'Rodada_Resultante']:
    ...
    # Corrigindo o erro de escopo/definição: inicializa o dicionário antes do loop
    Consolidado_dict = {} 
    ...
    for _, row in historico_completo.iterrows():
        ...
        if chave_consolidada not in Consolidado_dict:
            ...
            if nova_rodada_resultante is not None and nova_rodada_resultante != '-':
