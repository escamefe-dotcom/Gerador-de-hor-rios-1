...
# --------------------------------------------------------------------------------------
# --- BLOCO DE ANÁLISE ESTÁTICA (T1-T5) - ATUALIZADO COM OS NOVOS DADOS ---
# --------------------------------------------------------------------------------------
...
def obter_analise_finais_estatica() -> Tuple[pd.DataFrame, Dict[int, int], int]:
    ...
    # ATUALIZAÇÃO: NOVAS FREQUÊNCIAS DOS FINAIS DE MINUTO
    ...
    # ATUALIZAÇÃO: NOVO TOP 1 MINUTO ISOLADO
    top_1_minuto_completo = 57 
    
    # Criando o DataFrame para exibição na sidebar
    dados_exibicao = [
        {'Sinal': "🎯", 'Minuto Exemplo': f"{top_1_minuto_completo:02d}", 'Final': f"{7} (Minuto Isolado)"},
        {'Sinal': "🔥", 'Minuto Exemplo': "06", 'Final': 'T1(6)'},
        {'Sinal': "🔥", 'Minuto Exemplo': "03", 'Final': 'T2(3)'},
        {'Sinal': "🔥", 'Minuto Exemplo': "02", 'Final': 'T3(2)'}, 
        {'Sinal': "🔥", 'Minuto Exemplo': "09", 'Final': 'T4(9)'},
        {'Sinal': "🔥", 'Minuto Exemplo': "01", 'Final': 'T5(1)'},
    ]
            ...
            with st.spinner(f'Analisando Rodada {rodada} e consolidando histórico...'): 
                ...
                if novo_df_bruto is not None and not novo_df_bruto.empty:
                    ...
                    with st.sidebar:
                        ...
                        st.info(f"Classificação dos Finais: T1(6), T2(3), T3(2), T4(9), T5(1).")
