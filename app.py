...
# --------------------------------------------------------------------------------------
# --- BLOCO DE ANÁLISE ESTÁTICA (T1-T5) - ATUALIZADO NOVAMENTE ---
# --------------------------------------------------------------------------------------
...
def obter_analise_finais_estatica() -> Tuple[pd.DataFrame, Dict[int, int], int]:
    ...
    # CORREÇÃO FINAL: NOVAS FREQUÊNCIAS DOS FINAIS DE MINUTO
    # T1(3), T2(0), T3(2), T4(6), T5(7)
    ...
    # CORREÇÃO FINAL: NOVO TOP 1 MINUTO ISOLADO (17)
            ...
            with st.spinner(f'Analisando Rodada {rodada} e consolidando histórico...'): 
                ...
                if novo_df_bruto is not None and not novo_df_bruto.empty:
                    ...
                    with st.sidebar:
                        ...
                        st.info(f"Classificação dos Finais: T1(3), T2(0), T3(2), T4(6), T5(7).")
